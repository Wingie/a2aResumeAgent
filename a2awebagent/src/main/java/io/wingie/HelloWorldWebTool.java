...
@Service
@Slf4j
@Agent(groupName = "example", groupDescription = "Example web automation tools")
public class HelloWorldWebTool {
     ...
     */
    @Action(description = "Search for Hello World and demonstrate web automation")
    public String searchHelloWorld(String searchTerm) {
