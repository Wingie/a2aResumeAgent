...
import io.wingie.a2acore.tools4ai.api.MimeType;
import io.wingie.a2acore.tools4ai.predict.PredictionLoader;
import lombok.Getter;
import lombok.Setter;
import lombok.extern.slf4j.Slf4j;

// Using Files.probeContentType instead of jakarta.activation
...
public class GeminiImageActionProcessor {
    ...
    public String imageToText(String imageNameAndPath) throws AIProcessingException {
        try {
            String mimeType = Files.probeContentType(Path.of(imageNameAndPath));
            return imageToText(
