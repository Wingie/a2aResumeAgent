 ...
 */
@Service
@Agent(name = "resume", description = "Professional expertise and resume tools")
public class WingstonsProjectsExpertise {

    @Action(description = "Get comprehensive information about Wingston Sharon's technical expertise, project portfolio, and professional background", name = "getWingstonsProjectsExpertiseResume")
    public String getWingstonsProjectsExpertiseResume(@Parameter(description = "Focus area: overview, ai-ml, audio, web-automation, mcp, creative-coding, experience, education, metrics, leadership, all") String focusArea) {
